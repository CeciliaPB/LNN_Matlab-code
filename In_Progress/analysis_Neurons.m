%% ANALYSIS NEURONS
% Provides the steps to analyse the results from clusted neurons. Some of
% these scripts are earlier ideas and versions of already working
% functions.
%
% Uses the Timestamps (or TS) and Waveforms originated from MClust.
% 
% 1_ Plot waveforms: Included as part of the WAVEFORM_ANALYSIS function.
% 2_ Waveform calculations: Included as part of the WAVEFORM_ANALYSIS
% function. 
% 3_ neuron ISI histogram: Included as ISI_HIST function.
% 4_ Align to ttl/ behaviour: see behaviourly driven cells.
% 5_ Perform and save data from psth: Included as TTL_PSTH function.
%
% -------------------------------------------------------------------------
...
%% 2_ Waveform calculations
% First load group TimeStamps (GR1) and neuron TS (GR1_1)
% NOTE: Waveform time length = 900us (27units), 15 units = 500us.
A = TS/10000;
n = 1; % Channel
C = zeros(length(TimeStamps),1);
for ii = 1:length(A)
...
%% 5_ Perform and save data from psth and save to mat for each neuron
