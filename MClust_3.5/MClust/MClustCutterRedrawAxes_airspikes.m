...
% Overlay airpuff spikes
global ShowAirpuffSpikes
if isempty(ShowAirpuffSpikes)
    ShowAirpuffSpikes = false;
end
if ShowAirpuffSpikes
    overlayspk2
end
...
% -------------------------------------------------------------------------
function overlayspk2

% Get spike times
global AirpuffSpikes
global MClust_CurrentFeatureData
show_ts = AirpuffSpikes;
